...
-- 导出 tt_cron 的数据库结构
CREATE DATABASE IF NOT EXISTS `tt_cron` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `tt_cron`;

-- 导出  表 tt_cron.tt_admin 结构
...
-- 正在导出表  tt_cron.tt_admin 的数据：~2 rows (大约)
DELETE FROM `tt_admin`;
/*!40000 ALTER TABLE `tt_admin` DISABLE KEYS */;
INSERT INTO `tt_admin` (`id`, `username`, `password`, `email`, `salt`, `last_login`, `last_ip`, `status`, `create_at`, `update_at`) VALUES
	(1, 'admin', 'f52c9ce769d02d7575c27e905b00a9b1', '', '', 1531147072, 3232243201, 1, 0, 1531243580),
	(2, 'yangcai', 'f52c9ce769d02d7575c27e905b00a9b1', 'yangcaiemail@foxmai.com', '', 1531755647, 3232243201, 1, 1531641360, 1531755647);
/*!40000 ALTER TABLE `tt_admin` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_auth_access_log 结构
CREATE TABLE IF NOT EXISTS `tt_auth_access_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  tt_cron.tt_auth_access_log 的数据：~0 rows (大约)
DELETE FROM `tt_auth_access_log`;
/*!40000 ALTER TABLE `tt_auth_access_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `tt_auth_access_log` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_auth_group 结构
CREATE TABLE IF NOT EXISTS `tt_auth_group` (
...
-- 正在导出表  tt_cron.tt_auth_group 的数据：2 rows
DELETE FROM `tt_auth_group`;
/*!40000 ALTER TABLE `tt_auth_group` DISABLE KEYS */;
INSERT INTO `tt_auth_group` (`id`, `title`, `status`, `rules`, `create_at`, `update_at`) VALUES
	(1, '超级管理员', 1, '6,5,4,3,2,1', 0, 0),
	(2, '操作员', 1, '7,6,5,4', 0, 0);
/*!40000 ALTER TABLE `tt_auth_group` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_auth_group_access 结构
CREATE TABLE IF NOT EXISTS `tt_auth_group_access` (
...
-- 正在导出表  tt_cron.tt_auth_group_access 的数据：3 rows
DELETE FROM `tt_auth_group_access`;
/*!40000 ALTER TABLE `tt_auth_group_access` DISABLE KEYS */;
INSERT INTO `tt_auth_group_access` (`uid`, `group_id`) VALUES
	(1, 1),
	(2, 0),
	(2, 2);
/*!40000 ALTER TABLE `tt_auth_group_access` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_auth_rule 结构
CREATE TABLE IF NOT EXISTS `tt_auth_rule` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  tt_cron.tt_auth_rule 的数据：7 rows
DELETE FROM `tt_auth_rule`;
/*!40000 ALTER TABLE `tt_auth_rule` DISABLE KEYS */;
INSERT INTO `tt_auth_rule` (`id`, `name`, `title`, `type`, `status`, `condition`, `create_at`, `update_at`) VALUES
...
/*!40000 ALTER TABLE `tt_auth_rule` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_task 结构
...
-- 正在导出表  tt_cron.tt_task 的数据：~9 rows (大约)
DELETE FROM `tt_task`;
/*!40000 ALTER TABLE `tt_task` DISABLE KEYS */;
INSERT INTO `tt_task` (`id`, `user_id`, `server_id`, `group_id`, `task_name`, `task_type`, `description`, `cron_spec`, `single`, `command`, `status`, `timeout`, `execute_times`, `prev_time`, `create_at`, `update_at`) VALUES
...
/*!40000 ALTER TABLE `tt_task` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_task_group 结构
CREATE TABLE IF NOT EXISTS `tt_task_group` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
-- 正在导出表  tt_cron.tt_task_group 的数据：~3 rows (大约)
DELETE FROM `tt_task_group`;
/*!40000 ALTER TABLE `tt_task_group` DISABLE KEYS */;
INSERT INTO `tt_task_group` (`id`, `user_id`, `group_name`, `description`, `is_del`, `create_at`, `update_at`) VALUES
	(14, 0, '测试任务', '测试任务', 0, 1528248151, 1529734452),
	(15, 0, '预发布任务', '预发布任务', 0, 1529734469, 1529734469),
	(16, 0, '上线任务', '上线任务', 0, 1529734502, 1529734502);
/*!40000 ALTER TABLE `tt_task_group` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_task_log 结构
CREATE TABLE IF NOT EXISTS `tt_task_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  tt_cron.tt_task_log 的数据：~3 rows (大约)
DELETE FROM `tt_task_log`;
/*!40000 ALTER TABLE `tt_task_log` DISABLE KEYS */;
INSERT INTO `tt_task_log` (`id`, `task_id`, `output`, `error`, `status`, `process_time`, `create_at`, `update_at`) VALUES
...
/*!40000 ALTER TABLE `tt_task_log` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_task_server 结构
CREATE TABLE IF NOT EXISTS `tt_task_server` (
...
-- 正在导出表  tt_cron.tt_task_server 的数据：~0 rows (大约)
DELETE FROM `tt_task_server`;
/*!40000 ALTER TABLE `tt_task_server` DISABLE KEYS */;
/*!40000 ALTER TABLE `tt_task_server` ENABLE KEYS */;

-- 导出  表 tt_cron.tt_user 结构
...
-- 正在导出表  tt_cron.tt_user 的数据：~0 rows (大约)
DELETE FROM `tt_user`;
